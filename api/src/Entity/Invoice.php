...
class Invoice
{
    ...
    /**
     * @var string The identification number of the customer generated by the payment provider
     * @example ABC12345678
     *
     * @Gedmo\Versioned
     * @Groups({"read", "write"})
...
//    private $targetOrganization;
    ...
    /**
     * @var string The id of the active subscription (non commonground)
     *
     * @example ABC12678
     *
     * @Groups({"read","write"})
    ...
    public function setPaymentCustomerId(string $paymentCustomerId): self
    {
